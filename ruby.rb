...
#--------------------------------------------------
our_table = Tabela.new(ws)
puts our_table.kreirajTabelu
# pocetni red 14
# pocetni kolona 4
# duzina u redovima5
# sirina u kolonama3

our_table2 = Tabela.new(ws1)
#--------------------------------------------------

our_table.izvuciImenaKolonaIzWorksheeta(ws)
our_table2.izvuciImenaKolonaIzWorksheeta(ws1)

#imena kolona: ["prvaKolona", "drugaKolona", "trecaKolona"]
#--------------------------------------------------

# our_table.uzmiIndekse
our_table2.uzmiIndekse
# uzmi indekse: {"prvaKolona"=>4, "drugaKolona"=>5, "trecaKolona"=>6}
#--------------------------------------------------


our_table.popuniTabelu(ws)
our_table2.popuniTabelu(ws1)
#Tabela: [["Prva kolona", "Druga kolona", "Treca kolona"], ["1", "25", "3"], ["4", "3", "6"]]
#--------------------------------------------------

our_table.row(16)
our_table2.row(3)
#@tabela[broj - @pocetni_red]["1", "25", "3"]
#--------------------------------------------------

#kolone su mi indeksirane 4->prva,5->druga,6->treca
our_table.col(4)
# our_table2.col(2)
#["Druga kolona", "25", "3"]
#--------------------------------------------------

# our_table.each do |cell_value|
#   puts "Cell value: #{cell_value}"
# end
# Cell value: Prva kolona
# Cell value: Druga kolona
# Cell value: Treca kolona
# Cell value: 1
# Cell value: 25
# Cell value: 3
# Cell value: 4
